...
async def analyze_segment(
    *,
    ...
    try:
        ...
        return SegmentVlmResponse.model_validate(_normalize_segment_payload(payload))
        ...
        return SegmentVlmResponse.model_validate(_normalize_segment_payload(repaired))
